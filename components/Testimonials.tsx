    ...
    return (
        <section className='h-full p-4 md:p-0 py-[80px]'>
            <article className='container mx-auto md:p-[100px] flex flex-col'>
                <div className='mb-[100px] text-center text-[#07484A]'>
                ...
                <div className='flex flex-col md:flex-row'>
                    <div
                        className='min-w-[280px] min-h-[280px] max-w-full md:w-1/3 rounded-[20px] bg-cover bg-center mb-[51px] md:mb-0'
                        style={{
                            backgroundImage: 'url("images/Testimonials/image-1.jpg")'
                        }}
                    />

                    <div className='w-full md:w-2/3 h-full flex flex-col justify-between md:p-[54px]'>
